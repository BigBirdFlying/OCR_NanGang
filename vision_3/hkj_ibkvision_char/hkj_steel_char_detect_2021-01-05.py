...
def steel_char_detect(path_1,path_2,path_3,path_4):
    try:
        ...
        _, char_model_mini = efficientdet(phi=0,weighted_bifpn=True,num_classes=len(classes_mini),score_threshold=0.5)
        char_model_mini.load_weights('char_model_mini/char_model.h5', by_name=True)
        char_model_param_mini={'image_size':512,'classes':classes_mini,'score_threshold':0.5,'colors':colors_mini}
